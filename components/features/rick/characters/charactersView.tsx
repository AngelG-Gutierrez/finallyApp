    ...
    return(
        <View style={styles.scrollView}>
            ...
            <View style={styles.nav}>
                ...
                <Text style={styles.navText}>Página <Text>{page}</Text> de <Text>{data.info.pages}</Text></Text>
            ...
            <View><Text style={styles.characters}>Personajes: <Text style={styles.totals}>{data.info.count}</Text></Text></View>
